function Sub1 = importfile1(filename, startRow, endRow)
%IMPORTFILE 将文本文件中的数值数据作为矩阵导入。
%   SUB10 = IMPORTFILE(FILENAME) 读取文本文件 FILENAME 中默认选定范围的数据。
%
%   SUB10 = IMPORTFILE(FILENAME, STARTROW, ENDROW) 读取文本文件 FILENAME 的
%   STARTROW 行到 ENDROW 行中的数据。
%
% Example:
%   Sub10 = importfile('Sub_10.txt', 2, 16);
%
%    另请参阅 TEXTSCAN。

% 由 MATLAB 自动生成于 2020/09/22 21:27:20
